...
export const download_attachment: (a: number) => void;
export const open_ticket: (a: number) => void;
export const open_wiki_page: (a: number) => void;
export const delete_attachment: (a: number) => void;
...
export const wasm_bindgen__convert__closures_____invoke__h09a373c24dbcf94e: (a: number, b: number) => void;
